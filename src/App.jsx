...
function App() {
  ...
  }, [cantidad, meses]); //Cuando las dependencias (meses o cantidad) se ejecuta
  ...
  function handleChange(e){
    // console.log(+e.target.value);//El + cambia string a int
  ...
  //En el return se coloca todo lo que se va a mostrar en pantalla
  return (
